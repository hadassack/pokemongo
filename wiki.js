...
async function searchPokemon() {
    ...
    try {
        ...
        Object.entries(damageRelations).forEach(
            ([type, multiplier]) => {
        ...
        const resistancesHTML = resistances.length
            ...
            : `
                <span class="damage-none">
                    Nenhuma resistência encontrada.
                </span>
            `;
        ...
        const evolutionPokemonData = await Promise.all(
            ...
            evolutionNames.map(async name => {
                ...
                const evolutionPokemon =
                    await evolutionPokemonResponse.json();
                ...
                return {
                    ...
                    image:
                        evolutionPokemon.sprites.other[
                            "official-artwork"
                        ].front_default ||
        ...
        const allMoves = pokemon.moves.map(move => {
            ...
            return move.move.name.replaceAll("-", " ");
            ...
            <div class="pokemon-result">
                ...
                <div class="pokemon-image-area">
                    ...
                    <div class="pokemon-scanner">
                        ...
                        <div
                            class="scanner-circle scanner-circle-1"
                        ></div>

                        <div
                            class="scanner-circle scanner-circle-2"
                        ></div>
...
wikiContent.addEventListener(
    "click",
    function(event) {

        const evolutionCard =
            event.target.closest(".evolution-card");
...
wikiContent.addEventListener(
    ...
    function(event) {
        ...
        const toggleButton =
            event.target.closest(".moves-toggle");
        ...
        const movesSection =
            toggleButton.closest(".pokemon-moves");


        const hiddenMoves =
            movesSection.querySelectorAll(".hidden-move");


        const isExpanded =
            toggleButton.classList.contains("expanded");
